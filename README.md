...
| 路由 | 视图 | 看什么 |
|---|---|---|
| `#/kg` | 知识图谱 | d3 力导向，可聚焦某人的关系网 |
| `#/graph` | 师承总图 | 纵向树，一眼看清代际 |
| `#/roster` | 学案名录 | 17 学案分组展开 |
| `#/time` | 时间轴 | 按生卒年排布 |
| `#/geo` | 地理分布 | 17 省份，可与名录联动 |
| `#/orphan` | **孤点现象** | 52 个孤点为什么孤——见下 |
| `#/book/12` | 学案原文 | 卷前三篇 + 63 卷正文，古文竖读排版 |
| `#/book/x2` | 卷前 · 师说 | 刘宗周评骘明儒二十五家，排在卷一之前 |
| `#/yangming` | 阳明心学 | 四句教 + 14 章（镜像/矩阵/四象），顶部章节目录随滚动高亮，移动端横滑 |
| `#/kg/王阳明` | 聚焦 | 任一视图点人名都跳这里 |

旧版链接（`#v12`、`#kgf王阳明`、`#all`）会自动改写成新路由，不会 404。
...
├── smoke.mjs        31 项：真浏览器跑 8 个视图、点人物、验箭头朝向、验卷前三篇、默认页、阳明心学章节目录/置顶/原版结构/渐入/滚动监听
